...
static int detect_parent(void)
{
    ...
    while ((target_real_len = readlink(link_name, link_target, target_max_len)) == target_max_len)
    {
        target_max_len *= 2;
    ...
    if (!strcmp(basename(link_target), "softice"))
        res = RESULT_YES;
    if (!strcmp(basename(link_target), "ice"))
        res = RESULT_YES;
    if (!strcmp(basename(link_target), "idapro"))
        res = RESULT_YES;
    if (!strcmp(basename(link_target), "aida"))
        res = RESULT_YES;
    if (!strcmp(basename(link_target), "ida"))
        res = RESULT_YES;
    if (!strcmp(basename(link_target), "afd"))
        res = RESULT_YES;
    if (!strcmp(basename(link_target), "dlv"))
        res = RESULT_YES;
    if (!strcmp(basename(link_target), "delve"))
        res = RESULT_YES;
    if (!strcmp(basename(link_target), "gdb"))
        res = RESULT_YES;
    if (!strcmp(basename(link_target), "ald"))
        res = RESULT_YES;
    if (strstr(link_target, "lldb"))
        res = RESULT_YES;
    if (!strcmp(basename(link_target), "trace"))
        res = RESULT_YES;
    if (!strcmp(basename(link_target), "ptrace"))
        res = RESULT_YES;
